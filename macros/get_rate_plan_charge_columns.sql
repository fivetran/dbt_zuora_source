...
{% set columns = [
    ...
    {"name": "billing_period_alignment", "datatype": dbt.type_string()},
    ...
    {"name": "booking_provider_exchange_rate_date", "datatype": "date"},
    ...
    {"name": "dmrccurrency_rounding", "datatype": dbt.type_float()},
    {"name": "dmrchome_currency", "datatype": dbt.type_float()},
    {"name": "drawdown_rate", "datatype": dbt.type_float()},
    {"name": "drawdown_uom", "datatype": dbt.type_string()},
    {"name": "dtcv", "datatype": dbt.type_float()},
    {"name": "dtcvcurrency_rounding", "datatype": dbt.type_float()},
    ...
    {"name": "overage_calculation_option", "datatype": dbt.type_string()},
    {"name": "overage_unused_units_credit_option", "datatype": dbt.type_string()},
    {"name": "parent_account_id", "datatype": dbt.type_string()},
    {"name": "payment_term_snapshot", "datatype": dbt.type_string()},
    {"name": "prepaid_operation_type", "datatype": dbt.type_string()},
    {"name": "prepaid_quantity", "datatype": dbt.type_float()},
    {"name": "prepaid_total_quantity", "datatype": dbt.type_float()},
    {"name": "prepaid_uom", "datatype": dbt.type_string()},
    ...
    {"name": "rating_group", "datatype": dbt.type_string()},
    {"name": "recognized_revenue_accounting_code_id", "datatype": dbt.type_string()},
    {"name": "rev_rec_code", "datatype": dbt.type_string()},
    {"name": "rev_rec_trigger_condition", "datatype": dbt.type_string()},
    {"name": "revenue_recognition_rule_name", "datatype": dbt.type_string()},
    {"name": "rollover_apply", "datatype": dbt.type_string()},
    {"name": "rollover_periods", "datatype": dbt.type_int()},
    {"name": "segment", "datatype": dbt.type_int()},
    {"name": "sold_to_contact_id", "datatype": dbt.type_string()},
    {"name": "sold_to_contact_snapshot_id", "datatype": dbt.type_string()},
    ...
    {"name": "tcvcurrency_rounding", "datatype": dbt.type_float()},
    ...
    {"name": "validity_period_type", "datatype": dbt.type_string()},
