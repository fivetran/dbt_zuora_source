...
{% set columns = [
    ...
    {"name": "deferred_revenue_account", "datatype": dbt.type_string()},
    ...
    {"name": "legacy_revenue_reporting", "datatype": "boolean"},
    ...
    {"name": "number_of_period", "datatype": dbt.type_int()},
    ...
    {"name": "price_upsell_quantity_stacked", "datatype": "boolean"},
    ...
    {"name": "recognized_revenue_account", "datatype": dbt.type_string()},
    ...
    {"name": "smoothing_model", "datatype": dbt.type_string()},
    ...
    {"name": "usage_record_rating_option", "datatype": dbt.type_string()},
    {"name": "use_discount_specific_accounting_code", "datatype": "boolean"},
    {"name": "use_tenant_default_for_price_change", "datatype": "boolean"},
