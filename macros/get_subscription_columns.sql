...
{% set columns = [
    ...
    {"name": "cpq_bundle_json_id_qt", "datatype": dbt.type_string()},
    ...
    {"name": "opportunity_close_date_qt", "datatype": dbt.type_timestamp()},
    {"name": "opportunity_name_qt", "datatype": dbt.type_string()},
